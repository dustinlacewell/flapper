...
export type MdxFrontmatterFilterInput = {
    ...
    employer?: Maybe<StringQueryOperatorInput>;
    position?: Maybe<StringQueryOperatorInput>;
    start_year?: Maybe<IntQueryOperatorInput>;
    end_year?: Maybe<IntQueryOperatorInput>;
};
...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___docsUrl'
  | 'childrenMdx___frontmatter___githubUrl'
  | 'childrenMdx___frontmatter___employer'
  | 'childrenMdx___frontmatter___position'
  | 'childrenMdx___frontmatter___start_year'
  | 'childrenMdx___frontmatter___end_year'
  | 'childrenMdx___slug'
  | 'childrenMdx___body'
  ...
  | 'childMdx___frontmatter___docsUrl'
  | 'childMdx___frontmatter___githubUrl'
  | 'childMdx___frontmatter___employer'
  | 'childMdx___frontmatter___position'
  | 'childMdx___frontmatter___start_year'
  | 'childMdx___frontmatter___end_year'
  | 'childMdx___slug'
  | 'childMdx___body'
  | 'childMdx___excerpt'
  | 'childMdx___headings'
...
export type MdxFieldsEnum =
  ...
  | 'frontmatter___url'
  | 'frontmatter___docsUrl'
  | 'frontmatter___githubUrl'
  | 'frontmatter___employer'
  | 'frontmatter___position'
  | 'frontmatter___start_year'
  | 'frontmatter___end_year'
  | 'slug'
  | 'body'
  | 'excerpt'
  | 'headings'
