...
export type MdxFrontmatter = {
  ...
  sidebar_position?: Maybe<Scalars['Int']>;
};
...
export type MdxFrontmatterFilterInput = {
  ...
  menu_label?: Maybe<StringQueryOperatorInput>;
  sidebar_position?: Maybe<IntQueryOperatorInput>;
};
...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___menu_label'
  | 'childrenMdx___frontmatter___sidebar_position'
  | 'childrenMdx___slug'
  | 'childrenMdx___body'
  ...
  | 'childMdx___frontmatter___menu_label'
  | 'childMdx___frontmatter___sidebar_position'
  | 'childMdx___slug'
  | 'childMdx___body'
  | 'childMdx___excerpt'
  | 'childMdx___headings'
...
export type MdxFieldsEnum =
  ...
  | 'fileAbsolutePath'
  | 'frontmatter___title'
  | 'frontmatter___menu_label'
  | 'frontmatter___sidebar_position'
  | 'slug'
  | 'body'
  | 'excerpt'
  | 'headings'
